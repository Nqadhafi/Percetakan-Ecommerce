...
const formProduct = reactive({
  ...
  // We'll show images_json as textarea JSON for now:
  images_json:   props.product.images_json || [],
})
    ...
    <div class="border rounded-xl bg-white p-4 space-y-4">
      ...
      <div class="grid md:grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <div class="text-[11px] text-gray-500 mt-1">Digunakan untuk URL product.</div>
        </div>
        ...
        <div>
          ...
          <input type="number" min="1" v-model.number="formProduct.min_order_qty" class="w-full border rounded-md px-3 py-2" />
        ...
        <div>
          ...
          <input v-model="formProduct.variant_label" class="w-full border rounded-md px-3 py-2" placeholder="misal: Packaging, Ukuran" />
          <div class="text-[11px] text-gray-500 mt-1">
        ...
        <div>
          ...
          <input v-model="formProduct.thumbnail_url" class="w-full border rounded-md px-3 py-2 text-xs" />
          <div class="text-[11px] text-gray-500 mt-1">
        ...
        <div class="md:col-span-2">
          ...
          ></textarea>
          <div class="text-[11px] text-gray-500 mt-1">
            Array URL gambar. Sementara manual dulu.
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="border rounded-xl bg-white p-4 text-sm space-y-3">
        ...
        <div class="grid md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select v-model="newVariant.is_active" class="w-full border rounded-md px-3 py-2">
